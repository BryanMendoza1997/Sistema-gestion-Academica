    ...
    public class LlenarTreeView_FC
    {
       public   void LlenarTreeView(TreeView TreeView1)
        ...
        protected DataSet PDataset(string Select_Statement)
        {
            ...
            SqlConnection SqlCon = new SqlConnection("Data Source=BRYAN\\SQLEXPRESS;Initial Catalog=BDPI4;Password=programacion;Integrated Security=True"); 
        ...
        public void ConsultarImagenes(String imagen, Repeater Repeater1)
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=BRYAN\\SQLEXPRESS;Initial Catalog=BDPI4;Password=programacion;Integrated Security=True");
